...
const Index = () => {
    ...
    const {
        ...
        key: [KEYS.groups, id],
        url: URLS.groups,
        params: {key: KEYS.smallMechanos, parent: id},
        enabled: !!(id)
    });
                ...
                <div className="grid grid-cols-12 gap-x-8 mt-8 min-h-fit">
                    ...
                    </div>
                    {
                        get(materials, 'data.results', []).map(material => <div
                            ...
                            <Product template={(isActive == 0 || isActive == 2) ? 'list' : 'card'} viewUrl={'small-mechano'} img={'smallmechano_image'} code={'smallmechano_csr_code'}
